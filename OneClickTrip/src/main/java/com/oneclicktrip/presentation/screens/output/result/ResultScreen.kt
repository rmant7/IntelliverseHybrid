...
import com.oneclicktrip.BuildConfig
...
fun ResultScreen(
    ...
    // navigation-level one (Navigation()'s own topBar/bottomBar), and a
    // second nested Scaffold duplicated its system-bar inset reservation.
    ResultScreenContent(
        viewModel = viewModel,
        solutionResults = solutionResults.value,
        ...
        solvedByStyleTranslator = stringResource(string.solved_by_oneclicktrip),
