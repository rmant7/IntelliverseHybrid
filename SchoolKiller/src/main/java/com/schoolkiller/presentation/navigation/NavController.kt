...
import com.schoolkiller.presentation.screens.output.ocr.OcrScreenContent
import com.schoolkiller.presentation.screens.output.result.ResultScreen
...
fun Navigation(parentNavController: NavHostController?) {
    ...
    ApplicationScaffold(
        ...
        topBar = {
            AppTopBar(parentNavController, stringResource(R.string.app_name_schoolkiller), stringResource(R.string.schoolkiller_info))
        }
    )
